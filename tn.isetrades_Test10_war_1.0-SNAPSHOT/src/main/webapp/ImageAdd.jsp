...
<%@page import="org.openstack4j.model.image.v2.Image.ImageVisibility"%>
<%@page import="org.openstack4j.model.image.v2.DiskFormat"%>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="basic-elements">
                                        <form class="form-valide" action="ImageAddServlet" method="post">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name = "format" class="form-control">
                                                            <% for (DiskFormat dF : DiskFormat.values()) {
                                                                    out.println("<option value = " + dF.value() + ">" + dF.name() + "</option>");
                                                                }%>
                                                        </select>
                                                    </div>
                                                </div>                           
                                                <div class="col-lg-6">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                <label>Browse for OS Image</label>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">  
                                                                ...
                                                                <span class="switch switch-sm">
                                                                    <input name="protected" type="checkbox" class="switch" id="switch-sm">
                                                                    <label for="switch-sm">Protected</label>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input name ="mindisk" type="number" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label>Min Ram (GB)</label>
                                                                <input name="minram" type="number" class="form-control">
                                                            </div>      
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <center>
                                                        <button type="submit" class="btn btn-info btn-rounded m-b-10 m-l-">Add</button>
                                                    </center>
                                                </div>
                                            </div>
                                        </form>
