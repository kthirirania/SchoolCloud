    ...
    <body class="fix-header fix-sidebar">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-validation">
                                        <form class="form-valide" action="FlavorAdd" method="post">    
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-8 ml-auto">
                                                    <button type="submit" class="btn btn-primary" id="toastr-info-top-right" >Add</button>
                                                </div>
                                            </div>                                    
                                        </form>
                                    </div>
        ...
        <script>
            $('#toastr-info-top-right').on("click", function () {
                toastr.info('Flavor Added', 'Success', {
