                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">OS Images</h4>
                                    <h6 class="card-subtitle">Export data to Copy, CSV, Excel, PDF & Print</h6>
                                    <div class="table-responsive m-t-40">
                                        <form action="Image" methode="post" name="imageForm">
                                                ...
                                                <tbody>
                                                    <%
                                                        for (Image image : new ImageApiImpl().listAllImages()) {
                                                            out.println("<tr>"
                                                                    + "<td><input type='radio' name='imageId' value=" + image.getId() + " checked='checked'/></td>"
                                                                    + "<td class = 'rblack'>" + image.getName() + "</td>"
                                                                    + "<td class = 'rblack'>" + image.getCreatedAt() + "</td>"
                                                                    + "<td class = 'rblack'>" + image.getStatus() + "</td>"
                                                                    + "<td class = 'rblack'>" + image.getSize() + "</td>"
                                                                    + "<td class = 'rblack'>" + image.getVisibility().name() + "</td>"
                                                            );
                                                            out.println("</tr>");
                                                        }
                                                    %>
