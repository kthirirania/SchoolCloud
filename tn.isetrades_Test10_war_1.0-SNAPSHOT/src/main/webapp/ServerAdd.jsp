<%-- 
    ...
    Author     : Rania
--%>
<%@page import="tn.isetrades.test10.api.FlavorApiImpl"%>
<%@page import="org.openstack4j.model.compute.Flavor"%>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-validation">
                                        <form class="form-valide" action="ServerLaunch" method="post">    
                                            ...
                                            <div class="row p-t-20">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="description" type="text" id="firstName" class="form-control">
                                                        <small class="form-control-feedback"> </small>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group has-danger">
                                                        ...
                                                        <input name="count" type="number" id="lastName" class="form-control form-control-danger">
                                                        <small class="form-control-feedback"></small>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name = "image" class="form-control">
                                                            <%
                                                                for (Image image : new ImageApiImpl().listAllImages()) {
                                                                    out.println("<option value = " + image.getId() + ">" + image.getName() + "</option>");
                                                                }
                                                            %>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group has-danger">
                                                        <label class="control-label">Flavor</label>
                                                         <select name = "flavor" class="form-control">
                                                            <%
                                                                for (Flavor  flavor : new FlavorApiImpl().listAllFlavors()) {
                                                                    out.println("<option value = " + flavor.getId() + ">" + flavor.getName() + "</option>");
                                                                }
                                                            %>
                                                        </select>
                                                    </div>
