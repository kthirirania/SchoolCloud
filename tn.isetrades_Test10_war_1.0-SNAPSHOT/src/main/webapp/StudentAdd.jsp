                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-validation">
                                        ...
                                        <form class="form-valide" action="AddStudentServlet" method="POST">    
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="lname" type="text" id="firstName" class="form-control">
                                                    </div>
                                                    <div class="form-group has-danger">
                                                        <label class="control-label">Email</label>
                                                        <input name="email" type="email" id="email" class="form-control form-control-danger">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group has-danger">
                                                        ...
                                                        <input name="password" type="password" id="password" class="form-control form-control-danger">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
