        ...
        <div id="main-wrapper">
            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="index.jsp">Hardware</a></li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form action="Flavor" methode="post" name="flavoractions">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Accessible Hardware</h4>
                                                ...
                                                <tbody>
                                                    <%
                                                        for (Flavor flavor : new FlavorApiImpl().listAllFlavors()) {
                                                            out.println("<tr>"
                                                                    + "<td><input type='radio' name='flavor_radio' value=" + flavor.getId() + " checked='checked'/></td>"
                                                                    + "<td class = 'rblack'>" + flavor.getName() + "</td>"
                                                                    + "<td class = 'rblack'>" + flavor.getVcpus() + "</td>"
                                                                    + "<td class = 'rblack'>" + flavor.getDisk() + "</td>"
                                                                    + "<td class = 'rblack'>" + flavor.getRam() + "</td>"
                                                                    + "<td class = 'rblack'>" + flavor.getEphemeral() + "</td>");
