...
<html lang="en">
    ...
    <body class="fix-header fix-sidebar">
        ...
        <div id="main-wrapper">
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-bar-chart"></i><span class="hide-menu">Hardware</span></a>
                             ...
                             <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-envelope"></i><span class="hide-menu">Floating IPs</span></a>
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="FloattingView.jsp">View</a></li>
                                    <li><a href="FloattingAdd.jsp">Add</a></li>
                                </ul>
                            </li>
                            <li class="nav-label"></li>
                            <a href=""></a>
            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-primary">ISET Rades Cloud Dashboard</h3>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-validation">
                                        <form class="form-valide" action="FloattingAdd" method="post">    
                                            <div class="col-md-20  justify-content-center">
                                                <div class="form-group">
                                                    <label class="control-label">Name</label>
                                                    <input name="name" type="text" id="firstName" class="form-control">
                                            ...
                                            <div class="row p-t-20">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="ram" type="number" id="firstName" class="form-control">
                                                        <small class="form-control-feedback"> </small>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group has-danger">
                                                        ...
                                                        <input name="vcpus" type="number" id="lastName" class="form-control form-control-danger">
                                                        <small class="form-control-feedback"></small>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row p-t-20">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="disk" type="number" id="firstName" class="form-control">
                                                        <small class="form-control-feedback"></small>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group has-danger">
                                                        <label class="control-label">RxTx factor</label>
                                                        <input name="rxtx" type="number" id="lastName" class="form-control form-control-danger">
                                                        <small class="form-control-feedback"></small>
                                                    </div>
                                                </div>
                                                <!--/span-->
            ...
            <!-- footer -->
            <footer class="footer"> © 2018 All rights reserved. ISET Rades 2018</footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
        <!-- End Wrapper -->
