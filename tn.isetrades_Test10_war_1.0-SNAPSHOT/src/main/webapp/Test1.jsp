                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <form action="CoursesActions" methode="post" name="course">
                                                    <div class="table-responsive m-t-40">
                                                        <input type="submit" name ="action" value="Disable/Enable" class="btn btn-primary active">
                                                        <input type="submit" name ="action" value="Edit" class="btn btn-primary active">
                                                        <input type="submit" name ="action" value="Delete" class="btn btn-primary active">
                                                        <input type="submit" name ="action" value="ManageMembers" class="btn btn-primary active">   
                                                            ...
                                                            <tbody>
                                                                <%
                                                                    for (Course course : new CourseService().getCourseList()) {
                                                                        out.println("<tr>"
                                                                                + "<td><input type='radio' name='course_radio' value=" + course.getIdCourse() + " checked='checked'/></td>"
                                                                                + "<td class = 'rblack'>" + course.getName() + "</td>");
                                                                        if (course.isEnabled()) {
                                                                            out.println("<td class = 'rblack'> YES </td>");
                                                                        } else {
                                                                            out.println("<td class = 'rblack'> NO </td>");
                                                                        }
