...
<%@page import="tn.isetrades.test10.api.ProjectApiImpl"%>
<%@page import="org.openstack4j.model.identity.v3.Project"%>
<%@page import="org.openstack4j.model.identity.v3.Project"%>
<%@page import="tn.isetrades.test10.api.UserApiImpl"%>
<%@page import="org.openstack4j.model.identity.v3.User"%>
                ...
                <div class="scroll-sidebar">
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-suitcase"></i><span class="hide-menu">Students<span class="label label-rouded label-warning pull-right">2</span></span></a>
                                <ul aria-expanded="false" class="collapse">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="StudentsActions" methode="post" name="student">
                                        ...
                                        <input type="submit" name ="action" value="Add Course" class="btn btn-primary active">
                                        <label>Course</label>
                                        <select name = "course" class="form-control">
                                            <% for (Project project : new ProjectApiImpl().listprojects()) {
                                                    out.println("<option value = " + project.getId() + ">" + project.getName() + "</option>");
                                                }%>
                                        </select>
                                        <div class="table-responsive m-t-40">
                                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    <%
                                                        for (User user : new UserApiImpl().listUsers()) {
                                                            out.println("<tr>"
                                                                    + "<td><input type='radio' name='student_radio' value=" + user.getId() + " checked='checked'/></td>"
                                                                    + "<td class = 'rblack'>" + user.getName()+ "</td>"
                                                                    + "<td class = 'rblack'>" + user.getEmail()+ "</td>");
